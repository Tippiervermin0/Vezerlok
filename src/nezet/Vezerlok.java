...
public class Vezerlok extends javax.swing.JFrame {
    ...
    private void btnListbeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListbeActionPerformed
            ...
            if (jComboBox1.getSelectedIndex() > 0 || enged) {
    ...
    boolean enged = true;
    private void FejlecetEnged(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FejlecetEnged
        if(enged){
    ...
    private void jTabbedPane1AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jTabbedPane1AncestorAdded
        if(jRadioButton1.isEnabled() || jRadioButton2.isEnabled() || jRadioButton3.isEnabled()){
